...
namespace Kamgam.SettingsGenerator
{
    ...
    public class SettingsInitializer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Quick access to settings (if there are any). May return null.<br />
        ...
        public void Awake()
        {
            ...
            //
            // NOTICE: This approach is deprecated (as is the whole SettingsInitializer).
            // For custom load methods please use the SettingsSaver on the SettingsProvider instead.
            //
            // OLD Method of directly setting the callbacks:
            // Settings.CustomLoadMethod = customLoad; // Notice "Settings.CustomLoadMethod" is static so no load is happening yet.
