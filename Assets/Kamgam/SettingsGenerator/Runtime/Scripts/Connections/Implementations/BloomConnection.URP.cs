...
namespace Kamgam.SettingsGenerator
{
    public partial class BloomConnection : Connection<bool>
    {
        ...
        public BloomConnection()
        {
            ...
            // We achieve the same effect by taking the values so that the
...
#if UNITY_EDITOR
            var defaultBloom = SettingsVolume.Instance.FindDefaultVolumeComponent<Bloom>(useStackAsFallback: true, layerMask: Physics.AllLayers);
