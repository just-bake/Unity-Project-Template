...
namespace Kamgam.SettingsGenerator
{
    ...
    {
        /// <summary>
        /// Disable if the refresh rates change very often.
        /// </summary>
        ...
        public override void Set(int index)
        {
            ...
            {
                Logger.LogMessage("Setting the refresh rate has no effect in the Editor. Please try in a build. - " + SettingsGeneratorSettings.ShowEditorInfoLogsHint);
            }
#endif
        }
#endif
