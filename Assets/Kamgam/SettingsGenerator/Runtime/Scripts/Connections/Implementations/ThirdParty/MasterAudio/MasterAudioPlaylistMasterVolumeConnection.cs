...
{
    public class MasterAudioPlaylistMasterVolumeConnection : Connection<float>
    {
        /// <summary>
        ...
        public MasterAudioPlaylistMasterVolumeConnection(Vector2 inputRange)
        {
        ...
        {
            var volume = MasterAudioService.Utils.GetPlaylistMasterVolume();
        ...
        public override void Set(float volume)
        {
            ...
            MasterAudioService.Utils.SetPlaylistMasterVolume(clampedVolume);
        }
#endif
    }
}
