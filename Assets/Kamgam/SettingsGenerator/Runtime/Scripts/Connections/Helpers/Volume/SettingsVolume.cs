    ...
    public class SettingsVolume : MonoBehaviour
    {
        ...
        public T FindDefaultVolumeComponent<T>(bool useStackAsFallback = false, int layerMask = Physics.AllLayers) where T : VolumeComponent
        {
            ...
            if (useStackAsFallback)
            {
                ...
                if (Camera.main != null)
                {
                    unregisterFromVolumeManager(Volume, Camera.main.gameObject.layer);
                    ...
                    if (VolumeManager.instance.stack != null)
                    {
                        ...
                        registerWithVolumeManager(Volume, Camera.main.gameObject.layer);
        ...
        public void Update()
        {
            if (!_volumeWasRegisteredWithMananger && VolumeManager.instance.isInitialized && Camera.main != null)
            {
