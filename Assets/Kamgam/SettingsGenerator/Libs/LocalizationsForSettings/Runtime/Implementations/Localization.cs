...
namespace Kamgam.LocalizationForSettings
{
    ...
    public class Localization : ILocalization
    {
        ...
        [Header("Debug")]
        /// <summary>
        /// If true then the missing term will be logged in the Editor. In builds this will always be disabled.
        /// </summary>
        public bool LogMissingTerms = false;
...
#if UNITY_EDITOR
            if (!translated && LogMissingTerms)
            {
                Debug.Log("Localization is missing term: '" + term + "'");
            }
#endif
