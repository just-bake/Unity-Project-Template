...
namespace Kamgam.UGUIComponentsForSettings
{
    public static partial class InputUtils
    {
        ...
        private static int _lastMouseWheelChangeFrame = -1;
        private static Vector2 _lastMouseWheelValue;

        private static void OnInputEvent(InputEventPtr eventPtr, InputDevice device)
        {
            if (device != Mouse.current || (!eventPtr.IsA<StateEvent>() && !eventPtr.IsA<DeltaStateEvent>()))
                return;

            if (Mouse.current.scroll.HasValueChangeInEvent(eventPtr))
            {
                _lastMouseWheelValue = Mouse.current.scroll.ReadValueFromEvent(eventPtr);
                _lastMouseWheelChangeFrame = Time.frameCount;
            }
        }
        ...
        static List<UniversalKeyCode> _tmpUniversalKeyResults = new List<UniversalKeyCode>();
        ...
        static void buildKeyCache()
        {
            if (Keys == null)
            {
                ...
                {
                    Keys = Keyboard.current.allKeys.Where(k => k != null).Select(k => k.keyCode).ToArray();
                }
                else
                {
        ...
        {
            return _lastMouseWheelChangeFrame == Time.frameCount;
        }
        ...
        public static bool GetModifierKeyDown(UniversalKeyCode universalKeyCode)
        {
            ...
            GetModifierKeysDown(results: _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Returns true during the frame the user starts pressing any modifier key (Shift, Tab, Control, Command or Alt).<br />
        /// If you can please use Use GetModifierKeyDown(keyCode) or GetModifierKeysDown() instead.
        /// </summary>
        /// <returns></returns>
        ...
        {
            _tmpUniversalKeyResults.Clear();
            GetUniversalKeysDown(excludeModifierKeys: false, excludeMouseButtons: false, results: _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Returns the first key that was pressed during the last frame.<br />
        /// NOTICE: This may return varying results if multiple keys are pressed!<br />
        /// If you can please use GetUniversalKeyDown(keyCode) or GetUniversalKeysDown() instead.
        /// </summary>
        ...
        {
            _tmpUniversalKeyResults.Clear();
            GetUniversalKeysDown(excludeModifierKeys, excludeMouseButtons, _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Get the UniversalKeyCodes for the keys/mouse/buttons that were pressed down within the last frame.<br />
        /// Adds the key code to results or creates a new results list if needed.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <param name="results"></param>
        ...
        public static List<UniversalKeyCode> GetUniversalKeysDown(bool excludeModifierKeys, bool excludeMouseButtons, List<UniversalKeyCode> results)
        {
            ...
            {
                if (Mouse.current.leftButton.wasPressedThisFrame) results.Add(UniversalKeyCode.MouseLeft);
                if (Mouse.current.middleButton.wasPressedThisFrame) results.Add(UniversalKeyCode.MouseMiddle);
                if (Mouse.current.rightButton.wasPressedThisFrame) results.Add(UniversalKeyCode.MouseRight);
                if (Mouse.current.backButton.wasPressedThisFrame) results.Add(UniversalKeyCode.MouseBack);
                if (Mouse.current.forwardButton.wasPressedThisFrame) results.Add(UniversalKeyCode.MouseForward);
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y > 0.01f) results.Add(UniversalKeyCode.MouseWheelUp);
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y < -0.01f) results.Add(UniversalKeyCode.MouseWheelDown);
            }
            ...
            if (Gamepad.current != null && Gamepad.current.wasUpdatedThisFrame)
            {
                ...
                if (Gamepad.current.buttonSouth.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadSouth);
                if (Gamepad.current.buttonEast.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadEast);
                if (Gamepad.current.buttonWest.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadWest);
                if (Gamepad.current.buttonNorth.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadNorth);
                if (Gamepad.current.leftShoulder.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftShoulder);
                if (Gamepad.current.rightShoulder.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightShoulder);
                if (Gamepad.current.selectButton.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadSelect);
                if (Gamepad.current.startButton.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadStart);
                if (Gamepad.current.leftStickButton.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftStickButton);
                if (Gamepad.current.leftStick.up.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftStickUp);
                if (Gamepad.current.leftStick.down.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftStickDown);
                if (Gamepad.current.leftStick.left.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftStickLeft);
                if (Gamepad.current.leftStick.right.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftStickRight);
                if (Gamepad.current.rightStickButton.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightStickButton);
                if (Gamepad.current.rightStick.up.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightStickUp);
                if (Gamepad.current.rightStick.down.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightStickDown);
                if (Gamepad.current.rightStick.left.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightStickLeft);
                if (Gamepad.current.rightStick.right.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightStickRight);
                // These are "new" as in the old system the triggers were axis.
                if (Gamepad.current.leftTrigger.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadLeftTrigger);
                if (Gamepad.current.rightTrigger.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadRightTrigger);
                // These are "new" as in the old system the dpad buttons were axis
                if (Gamepad.current.dpad.left.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadDPadLeft);
                if (Gamepad.current.dpad.right.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadDPadRight);
                if (Gamepad.current.dpad.up.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadDPadUp);
                if (Gamepad.current.dpad.down.wasPressedThisFrame) results.Add(UniversalKeyCode.GamePadDPadDown);
            }
            ...
            if (Joystick.current != null && Joystick.current.wasUpdatedThisFrame)
            {
                ...
                for (int i = 0; i < controls.Count; i++)
                {
                    ...
                    if (button.wasPressedThisFrame)
                    {
                        if (i == 0) results.Add(UniversalKeyCode.JoystickButton0);
                        if (i == 1) results.Add(UniversalKeyCode.JoystickButton1);
                        if (i == 2) results.Add(UniversalKeyCode.JoystickButton2);
                        if (i == 3) results.Add(UniversalKeyCode.JoystickButton3);
                        if (i == 4) results.Add(UniversalKeyCode.JoystickButton4);
                        if (i == 5) results.Add(UniversalKeyCode.JoystickButton5);
                        if (i == 6) results.Add(UniversalKeyCode.JoystickButton6);
                        if (i == 7) results.Add(UniversalKeyCode.JoystickButton7);
                        if (i == 8) results.Add(UniversalKeyCode.JoystickButton8);
                        if (i == 9) results.Add(UniversalKeyCode.JoystickButton9);
                        if (i == 10) results.Add(UniversalKeyCode.JoystickButton10);
                    }
                }
            }
        ...
        /// <summary>
        /// Returns true if the given key was released within the last frame.
        /// </summary>
        /// <returns></returns>
        public static bool GetUniversalKeyUp(UniversalKeyCode universalKeyCode)
        {
            _tmpUniversalKeyResults.Clear();
            GetUniversalKeysUp(excludeModifierKeys: false, excludeMouseButtons: false, results: _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Returns the first key that was released during the last frame.<br />
        /// NOTICE: This may return varying results if multiple keys are pressed!<br />
        /// If you can please use GetUniversalKeyUp(keyCode) or GetUniversalKeysUp() instead.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <returns></returns>
        ...
        {
            _tmpUniversalKeyResults.Clear();
            GetUniversalKeysUp(excludeModifierKeys, excludeMouseButtons, _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Gets the UniversalKeyCodes for the key/mouse/button that was pressed down within the last frame. Adds the key codes to the results or creates a new results list.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <param name="results"></param>
        ...
        public static List<UniversalKeyCode> GetUniversalKeysUp(bool excludeModifierKeys, bool excludeMouseButtons, List<UniversalKeyCode> results)
        {
            ...
            if (!excludeMouseButtons && Mouse.current != null)
            {
                if (Mouse.current.leftButton.wasReleasedThisFrame) results.Add(UniversalKeyCode.MouseLeft);
                if (Mouse.current.middleButton.wasReleasedThisFrame) results.Add(UniversalKeyCode.MouseMiddle);
                if (Mouse.current.rightButton.wasReleasedThisFrame) results.Add(UniversalKeyCode.MouseRight);
                if (Mouse.current.backButton.wasReleasedThisFrame) results.Add(UniversalKeyCode.MouseBack);
                if (Mouse.current.forwardButton.wasReleasedThisFrame) results.Add(UniversalKeyCode.MouseForward);
                // Since mouse wheel does not trigger any event we simply assume up events for every frame that the wheel was changed in.
                // Which means you will get down and up in the same frame.
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y > 0.01f) results.Add(UniversalKeyCode.MouseWheelUp);
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y < -0.01f) results.Add(UniversalKeyCode.MouseWheelDown);
            }
            ...
            if (Gamepad.current != null && Gamepad.current.wasUpdatedThisFrame)
            {
                // Conversions based on the Windows Xbox Controller layout
                // See: https://answers.unity.com/storage/temp/134371-xbox-one-controller-unity-windows-macos.jpg
                if (Gamepad.current.buttonSouth.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadSouth);
                if (Gamepad.current.buttonEast.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadEast);
                if (Gamepad.current.buttonWest.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadWest);
                if (Gamepad.current.buttonNorth.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadNorth);
                if (Gamepad.current.leftShoulder.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftShoulder);
                if (Gamepad.current.rightShoulder.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightShoulder);
                if (Gamepad.current.selectButton.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadSelect);
                if (Gamepad.current.startButton.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadStart);
                if (Gamepad.current.leftStickButton.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftStickButton);
                if (Gamepad.current.leftStick.up.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftStickUp);
                if (Gamepad.current.leftStick.down.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftStickDown);
                if (Gamepad.current.leftStick.left.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftStickLeft);
                if (Gamepad.current.leftStick.right.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftStickRight);
                if (Gamepad.current.rightStickButton.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightStickButton);
                if (Gamepad.current.rightStick.up.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightStickUp);
                if (Gamepad.current.rightStick.down.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightStickDown);
                if (Gamepad.current.rightStick.left.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightStickLeft);
                if (Gamepad.current.rightStick.right.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightStickRight);
                // These are "new" as in the old system the triggers were axis.
                if (Gamepad.current.leftTrigger.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadLeftTrigger);
                if (Gamepad.current.rightTrigger.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadRightTrigger);
                // These are "new" as in the old system the dpad buttons were axis
                if (Gamepad.current.dpad.left.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadDPadLeft);
                if (Gamepad.current.dpad.right.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadDPadRight);
                if (Gamepad.current.dpad.up.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadDPadUp);
                if (Gamepad.current.dpad.down.wasReleasedThisFrame) results.Add( UniversalKeyCode.GamePadDPadDown);
            }
        ...
        {
            _tmpUniversalKeyResults.Clear();
            GetPressedUniversalKeys(excludeModifierKeys: false, excludeMouseButtons: false, results: _tmpUniversalKeyResults);
        ...
        /// <summary>
        /// Returns the first key that was pressed or held down during the last frame.<br />
        /// NOTICE: This may return varying results if multiple keys are pressed!<br />
        /// If you can please use GetUniversalKey(keyCode) or GetPressedUniversalKeys() instead.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <param name="results"></param>
        ...
        /// <summary>
        /// Adds the currently held down universal key codes to the given results list (creates a new list if results = null).
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <param name="results"></param>
        /// <returns>Returns an empty list of no key was pressed.</returns>
        public static List<UniversalKeyCode> GetPressedUniversalKeys(bool excludeModifierKeys, bool excludeMouseButtons, List<UniversalKeyCode> results = null)
        {
            ...
            if (!excludeMouseButtons && Mouse.current != null)
            {
                if (Mouse.current.leftButton.isPressed) results.Add(UniversalKeyCode.MouseLeft);
                if (Mouse.current.middleButton.isPressed) results.Add(UniversalKeyCode.MouseMiddle);
                if (Mouse.current.rightButton.isPressed) results.Add(UniversalKeyCode.MouseRight);
                if (Mouse.current.backButton.isPressed) results.Add(UniversalKeyCode.MouseBack);
                if (Mouse.current.forwardButton.isPressed) results.Add(UniversalKeyCode.MouseForward);
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y > 0.01f) results.Add(UniversalKeyCode.MouseWheelUp);
                if (_lastMouseWheelChangeFrame == Time.frameCount && _lastMouseWheelValue.y < -0.01f) results.Add(UniversalKeyCode.MouseWheelDown);
            }
            ...
            if (Gamepad.current != null)
            {
                // Conversions based on the Windows Xbox Controller layout
                // See: https://answers.unity.com/storage/temp/134371-xbox-one-controller-unity-windows-macos.jpg
                if (Gamepad.current.buttonSouth.isPressed) results.Add(UniversalKeyCode.GamePadSouth);
                if (Gamepad.current.buttonEast.isPressed) results.Add(UniversalKeyCode.GamePadEast);
                if (Gamepad.current.buttonWest.isPressed) results.Add(UniversalKeyCode.GamePadWest);
                if (Gamepad.current.buttonNorth.isPressed) results.Add(UniversalKeyCode.GamePadNorth);
                if (Gamepad.current.leftShoulder.isPressed) results.Add(UniversalKeyCode.GamePadLeftShoulder);
                if (Gamepad.current.rightShoulder.isPressed) results.Add(UniversalKeyCode.GamePadRightShoulder);
                if (Gamepad.current.selectButton.isPressed) results.Add(UniversalKeyCode.GamePadSelect);
                if (Gamepad.current.startButton.isPressed) results.Add(UniversalKeyCode.GamePadStart);
                if (Gamepad.current.leftStickButton.isPressed) results.Add(UniversalKeyCode.GamePadLeftStickButton);
                if (Gamepad.current.leftStick.up.isPressed) results.Add(UniversalKeyCode.GamePadLeftStickUp);
                if (Gamepad.current.leftStick.down.isPressed) results.Add(UniversalKeyCode.GamePadLeftStickDown);
                if (Gamepad.current.leftStick.left.isPressed) results.Add(UniversalKeyCode.GamePadLeftStickLeft);
                if (Gamepad.current.leftStick.right.isPressed) results.Add(UniversalKeyCode.GamePadLeftStickRight);
                if (Gamepad.current.rightStickButton.isPressed) results.Add(UniversalKeyCode.GamePadRightStickButton);
                if (Gamepad.current.rightStick.up.isPressed) results.Add(UniversalKeyCode.GamePadRightStickUp);
                if (Gamepad.current.rightStick.down.isPressed) results.Add(UniversalKeyCode.GamePadRightStickDown);
                if (Gamepad.current.rightStick.left.isPressed) results.Add(UniversalKeyCode.GamePadRightStickLeft);
                if (Gamepad.current.rightStick.right.isPressed) results.Add(UniversalKeyCode.GamePadRightStickRight);
                // These are "new" as in the old system the triggers were axis.
                if (Gamepad.current.leftTrigger.isPressed) results.Add(UniversalKeyCode.GamePadLeftTrigger);
                if (Gamepad.current.rightTrigger.isPressed) results.Add(UniversalKeyCode.GamePadRightTrigger);
                // These are "new" as in the old system the dpad buttons were axis
                if (Gamepad.current.dpad.left.isPressed) results.Add(UniversalKeyCode.GamePadDPadLeft);
                if (Gamepad.current.dpad.right.isPressed) results.Add(UniversalKeyCode.GamePadDPadRight);
                if (Gamepad.current.dpad.up.isPressed) results.Add(UniversalKeyCode.GamePadDPadUp);
                if (Gamepad.current.dpad.down.isPressed) results.Add(UniversalKeyCode.GamePadDPadDown);
            }
        ...
        public static string UniversalKeyName(UniversalKeyCode keyCode)
        {
            ...
            if (keyNameDictionary.Count == 0)
            {
                ...
                keyNameDictionary.Add(UniversalKeyCode.Mouse6, "Mouse 6");
                keyNameDictionary.Add(UniversalKeyCode.Mouse7, "Mouse 7");
                keyNameDictionary.Add(UniversalKeyCode.MouseWheelUp, "Mouse Wheel Up");
                keyNameDictionary.Add(UniversalKeyCode.MouseWheelDown, "Mouse Wheel Down");
