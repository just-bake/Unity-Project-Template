...
namespace Kamgam.UGUIComponentsForSettings
{
    public static partial class InputUtils
    {
        ...
        static void buildKeyCodeCacheIfNecessary()
        {
            if (KeyCodes == null)
            {
        ...
        {
            return InputAxisButtonEvents.GetButtonUp(UniversalKeyCode.MouseWheelUp) || InputAxisButtonEvents.GetButtonUp(UniversalKeyCode.MouseWheelDown);
        }
        ...
        public static bool GetModifierKeyDown(UniversalKeyCode universalKeyCode)
        {
            ...
            if (_tmpUniversalKeyResults.Count == 0)
                ...
                return _tmpUniversalKeyResults[0] == universalKeyCode;
        }

        /// <summary>
        /// Returns true during the frame the user starts pressing any modifier key (Shift, Tab, Control, Command or Alt).<br />
        /// NOTICE: This may return varying results if multiple modifier keys are pressed!<br />
        /// If you can please use GetModifierKeyDown(keyCode) or GetModifierKeysDown() instead.
        /// </summary>
        /// <returns></returns>
        ...
        public static List<UniversalKeyCode> GetModifierKeysDown(List<UniversalKeyCode> results = null)
        {
            ...
            if (Input.GetKeyDown(KeyCode.LeftShift)) results.Add(UniversalKeyCode.LeftShift);
            if (Input.GetKeyDown(KeyCode.RightShift)) results.Add(UniversalKeyCode.RightShift);
            if (Input.GetKeyDown(KeyCode.Tab)) results.Add(UniversalKeyCode.Tab);
            if (Input.GetKeyDown(KeyCode.LeftControl)) results.Add(UniversalKeyCode.LeftControl);
            if (Input.GetKeyDown(KeyCode.RightControl)) results.Add(UniversalKeyCode.RightControl);
            if (Input.GetKeyDown(KeyCode.LeftCommand)) results.Add(UniversalKeyCode.LeftCommand);
            if (Input.GetKeyDown(KeyCode.RightCommand)) results.Add(UniversalKeyCode.RightCommand);
            if (Input.GetKeyDown(KeyCode.LeftAlt)) results.Add(UniversalKeyCode.LeftAlt);
            if (Input.GetKeyDown(KeyCode.RightAlt)) results.Add(UniversalKeyCode.RightAlt);

            return results;
        }

        /// <summary>
        /// Returns true if that was pressed during the last frame.
        /// </summary>
        ...
        /// <summary>
        /// Get the UniversalKeyCodes for the keys/mouse/buttons that were pressed down within the last frame.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        ...
        public static List<UniversalKeyCode> GetUniversalKeysDown(bool excludeModifierKeys, bool excludeMouseButtons, List<UniversalKeyCode> results)
        {
            ...
            {
                for (int i = 0; i < InputAxisButtonEvents.DownButtonCount; i++)
                {
                    var btn = InputAxisButtonEvents.GetDownButtonAt(i);
                    if (excludeMouseButtons && (btn == UniversalKeyCode.MouseWheelDown || btn == UniversalKeyCode.MouseWheelUp))
                    {
                        continue;
                    }
        ...
        /// NOTICE: This may return varying results if multiple keys are released!<br />
        ...
        /// <summary>
        /// Get the UniversalKeyCodes for the keys/mouse/buttons that were released during the last frame.
        /// </summary>
        /// <param name="excludeModifierKeys"></param>
        /// <param name="excludeMouseButtons"></param>
        /// <returns></returns>
        public static List<UniversalKeyCode> GetUniversalKeysUp(bool excludeModifierKeys, bool excludeMouseButtons, List<UniversalKeyCode> results = null)
        {
            ...
            foreach (KeyCode keyCode in KeyCodes)
            {
                ...
                {
                    for (int i = 0; i < InputAxisButtonEvents.UpButtonCount; i++)
                    {
                        var btn = InputAxisButtonEvents.GetUpButtonAt(i);
                        if (excludeMouseButtons && (btn == UniversalKeyCode.MouseWheelDown || btn == UniversalKeyCode.MouseWheelUp))
                        {
                            continue;
                        }
        ...
        /// Key codes are somewhat layout dependent (Z and Y switch correctly for EN / DE) but others don't, ��� for example.
        /// </summary>
        ...
        public static string UniversalKeyName(UniversalKeyCode keyCode)
        {
            switch (keyCode)
            {
                ...
                case UniversalKeyCode.Mouse6: return "Mouse 6";
                case UniversalKeyCode.Mouse7: return "Mouse 7";
                case UniversalKeyCode.MouseWheelDown: return "Mouse Wheel Down";
                case UniversalKeyCode.MouseWheelUp: return "Mouse Wheel Up";
        ...
        {
            return keyCode == UniversalKeyCode.MouseWheelUp || keyCode == UniversalKeyCode.MouseWheelDown;
        }
        ...
        public static UniversalKeyCode KeyCodeToUniversalKeyCode(KeyCode keyCode, bool convertJoyStickToGamePad)
        {
            switch (keyCode)
            {
                ...
                case KeyCode.Mouse1: return UniversalKeyCode.MouseRight;
                case KeyCode.Mouse2: return UniversalKeyCode.MouseMiddle;
                case KeyCode.Mouse3: return UniversalKeyCode.MouseBack;
                case KeyCode.Mouse4: return UniversalKeyCode.MouseForward;
                case KeyCode.Mouse5: return UniversalKeyCode.Mouse6;
                case KeyCode.Mouse6: return UniversalKeyCode.Mouse7;
            }
        ...
        public static KeyCode UniversalKeyCodeToKeyCode(UniversalKeyCode universalKeyCode)
        {
            switch (universalKeyCode)
            {
                ...
                case UniversalKeyCode.MouseRight: return KeyCode.Mouse1;
                case UniversalKeyCode.MouseMiddle: return KeyCode.Mouse2;
                case UniversalKeyCode.MouseBack: return KeyCode.Mouse3;
                case UniversalKeyCode.MouseForward: return KeyCode.Mouse4;
                case UniversalKeyCode.Mouse6: return KeyCode.Mouse5;
                case UniversalKeyCode.Mouse7: return KeyCode.Mouse6;
