...
namespace Kamgam.UGUIComponentsForSettings
{
    ...
    public class AutoNavigationOverrides : MonoBehaviour, ISelectHandler, IUpdateSelectedHandler
    {
        ...
        public void Awake()
        {
            ...
            // Disabled self if no overrides are specified
        ...
        {
            if (!IsBlockingAnyDirection && !BlockUp &&
                SelectOnUpOverride != null && SelectOnUpOverride.isActiveAndEnabled && SelectOnUpOverride.interactable)
            {
        ...
        {
            if (!IsBlockingAnyDirection && !BlockDown &&
                SelectOnDownOverride != null && SelectOnDownOverride.isActiveAndEnabled && SelectOnDownOverride.interactable)
            {
        ...
        {
            if (!IsBlockingAnyDirection && !BlockLeft &&
                SelectOnLeftOverride != null && SelectOnLeftOverride.isActiveAndEnabled && SelectOnLeftOverride.interactable)
            {
        ...
        {
            if (!IsBlockingAnyDirection && !BlockRight &&
                SelectOnRightOverride != null && SelectOnRightOverride.isActiveAndEnabled && SelectOnRightOverride.interactable)
            {
