...
namespace OPS.Obfuscator
{
    public class BuildPostProcessor : IPreprocessBuildWithReport, IFilterBuildAssemblies, IPostBuildPlayerScriptDLLs, IUnityLinkerProcessor, IPostprocessBuildWithReport
    {
        ...
        private static OPS.Obfuscator.Editor.Settings.Unity.Build.BuildSettings PrepareBuildSettings(BuildReport _Report)
        {
            ...
            var_BuildSettings.Compression = _Report.summary.options.HasFlag(BuildOptions.CompressWithLz4) ? OPS.Editor.Settings.Unity.Build.CompressionType.Lz4 :
                           _Report.summary.options.HasFlag(BuildOptions.CompressWithLz4HC) ? OPS.Editor.Settings.Unity.Build.CompressionType.Lz4HC :
                           OPS.Editor.Settings.Unity.Build.CompressionType.None;
